...
def main():
    ...
    ann_files = ["datasets/collated_outputs/urchininf_v0/annotations/instances_train2023_urchin.json",
                 "datasets/collated_outputs/urchininf_rov_v1/annotations/instances_train2023_urchin.json",
                 "datasets/collated_outputs/nudi_urchin_auv_v2/annotations/instances_train2023_urchin.json"]
    ann_files = ["datasets/collated_outputs/urchininf_v0/annotations/instances_test2023_urchin.json",
                 "datasets/collated_outputs/urchininf_rov_v1/annotations/instances_test2023_urchin.json",
                 "datasets/collated_outputs/nudi_urchin_auv_v2/annotations/instances_test2023_urchin.json"]
    ann_files = ["datasets/squidle_coco/squidle_urchin_2009/annotations/instances_train2023.json",
                 "datasets/squidle_coco/squidle_east_tas_urchins/annotations/instances_train2023.json"]
    # ann_files = ["../AnnotationMapping/outputs/squidle_redcup_train/annotations/instances_train.json"]
    img_dirs = ["datasets/squidle_coco/squidle_urchin_2009/train2023",
                "datasets/squidle_coco/squidle_east_tas_urchins/train2023"]
