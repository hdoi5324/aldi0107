...
sbatch --partition=accel tools/saga_slurm_train_net.sh Base-RCNN-FPN-urchininf_strongaug_ema.yaml "OUTPUT_DIR \'outputs/handfishinf/base_strongaug_ema_sq/\' DATASETS.TRAIN \(\'trench_handfish_auv_v1_train\',\'nudi_handfish_auv_v1_train\',\) DATASETS.TEST \(\'squidle_handfish_15800_test\',\)  LOGGING.GROUP_TAGS HI2SQ,H1 "

python tools/train_net.py --config-file configs/urchininf/Base-RCNN-FPN-urchininf_weakaug.yaml "OUTPUT_DIR \'outputs/handfishinf/base_weakaug_sq/\' DATASETS.TRAIN \(\'nudi_handfish_auv_v1_train\',\'nudi_handfish_auv_v2_train\',\'nudi_handfish_rov_v3_train\',\'trench_handfish_auv_v1_train\',\) DATASETS.TEST \(\'squidle_handfish_15800_test\',\)  LOGGING.GROUP_TAGS HI2SQ,H1 "
...
# EVAL
sbatch --partition=accel tools/saga_slurm_train_net.sh Base-RCNN-FPN-urchininf_strongaug_ema.yaml --eval-only "OUTPUT_DIR \'outputs/handfishinf/base_strongaug_ema_sq/\' DATASETS.TEST \(\'squidle_handfish_15800_test\',\)  LOGGING.GROUP_TAGS HI2SQ,H1 MODEL.WEIGHTS \'outputs/handfishinf/base_strongaug_ema_sq/model_final.pth\' "
...
sbatch --partition=accel tools/saga_slurm_train_net.sh Base-RCNN-FPN-urchininf_strongaug_ema.yaml "OUTPUT_DIR \'outputs/handfishinf/base_inf_sqall/\' DATASETS.TEST \(\'squidle_handfish_15800_test\',\) DATASETS.TRAIN \(\'nudi_handfish_auv_v1_train\',\'trench_handfish_auv_v1_train\',\'squidle_handfish_15800_train\',\) LOGGING.GROUP_TAGS HI2SQ,H1,ALL "
