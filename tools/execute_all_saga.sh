...
sbatch --partition=accel tools/saga_slurm_train_net.sh ALDI-urchininf.yaml "OUTPUT_DIR \'outputs/urchininf/aldi_inf_udd100/\' LOGGING.GROUP_TAGS Inf+100tgt2UDD,T3 DATASETS.UNLABELED \(\) DATASETS.TRAIN \(\'urchininf_v0_train\',\'urchininf_rov_v1_train\',\'urchininf_auv_v2_train\',\'UDD_train_split100\',\) "
